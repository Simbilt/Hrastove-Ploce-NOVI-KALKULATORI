...
window.addEventListener("load", () => {
    const widthInput = document.querySelector(".widthPP");
    const lenthInput = document.querySelector(".lengthPP");
...
const getPricePP = async () => {
  ...
  console.log(spreadSelectPP.value / 1000);
  ...
  console.log(thicknesPP);
  console.log(classSelectPP);
  //   console.log("LenghtNumber", lengthNumber);
  let newStaticPricePP = pricesPP[lengthNumber][thicknesPP][classSelectPP];
  if (spreadSelectPP.value > 0 || tonningSelect.value > 0) {
      const first = (Number(widthPP.value/100) + Number(thicknesPP/1000))
      const second = (Number(lengthPP.value/100) + Number(thicknesPP/1000))


      const third = (first * second) * 2;
      console.log(third)
    displayedPrice =  third * newStaticPricePP;
  }
  ...
  console.log("da", displayedPrice );
  newStaticPricePP = Number(newStaticPricePP);
  console.log("newStaticPrice", newStaticPricePP)
  ...
  console.log(displayedPrice);
  priceSpan.innerHTML = `${displayedPrice + Number(spreadSelectPP.value) + Number(tonningSelect.value)}€`;
};
